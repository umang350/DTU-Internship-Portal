...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mywebview.loadUrl("http://www.sip.ecelldtu.in/"); //yeh phir bhi itni sundar nhi banegi lekin joh websites proper khulti
        // hai on mobile woh bahut shi lagti hai eg: easyonlineconverter.com
...
////                ViewGroup.LayoutParams params = progressDialog.getWindow().getAttributes();
////                // params.y=100;
////               // progressDialog.getWindow().setM();
